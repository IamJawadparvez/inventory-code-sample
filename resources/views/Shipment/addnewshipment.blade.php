    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12  bs-linebreak">
                ...
                <form method="Post" action="{{route('save-issue-shipment')}}">
                    @csrf
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="row" class="col-md-12" id="Shippingcheckbox">
                                    ...
                                    <div class="col-md-4 d-none shippingfield">
                                        <div class="form-group">
                                            <label> 
                                                <strong>{{trans('file.Attach Document')}}</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4 d-none shippingfield">
                                        <div class="form-group">
                                            <label> 
                                                <strong>{{trans('file.Driver Name')}}</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4 d-none shippingfield">
                                        <div class="form-group">
                                            <label> 
                                                <strong>{{trans('file.Driver Contact Detail')}}</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4 d-none shippingfield">
                                        <div class="form-group">
                                            <label> 
                                                <strong>{{trans('file.Vechile Details')}}</strong>
                                            </label>
