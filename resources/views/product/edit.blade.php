                              ...
                              <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="store_id" required class="form-control selectpicker" id="store_id">
                                                <option value="{{NULL}}">Choose</option>
                                                @foreach($store as $s)
                                                    <option <?php if($s->store_id==$lims_product_data->store_id) echo "selected='selected'"; ?> value="{{$s->id}}">{{$s->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
