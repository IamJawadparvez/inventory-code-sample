        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#production" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span>{{__('file.production')}}</span><span></a>
                <ul id="production" class="collapse list-unstyled ">
                  <!-- -->
                  @if($index_permission_active)

                  <li id="production-list-menu"><a href="{{route('productionlist')}}">{{__('file.production_list')}}</a></li>
                  ...
                  <li id="production-create-menu"><a href="{{route('createproduction')}}">{{__('file.add_production')}}</a></li> 




                    <li id="production-create-menu"><a href="{{route('allproductionrequests')}}">{{__('file.production requests')}}</a></li>                  
                  
                    <li id="production-create-menu"><a href="{{route('allrequestform')}}">{{__('production requests form')}}</a></li> 

                   <li id="production-create-menu"><a href="{{route('production.categories')}}">{{__('file.Production categories')}}</a></li>  
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i><span>{{trans('file.Purchase')}}</span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  ...
                  @if($purchase_category_perm)

                 <li id="purchase-category-menu"><a href="{{route('purchase_category')}}">{{trans('file.Purchase Category')}}</a></li>
                  @endif

                  @if($purchase_category_perm)

                 <li id="purchase-category-menu"><a href="{{route('AddRawMaterial')}}">{{trans('file.Add Raw Material')}}</a></li>
                  @endif
                  ...
                  @if($purchaserawMaterial)

                  <li id="purchase-raw-material-menu"><a href="{{route('PurchaseRawMaterial')}}">{{trans('file.Raw Material List')}}</a></li>                  
                  @endif
               ...
               <!--    @if($purchaseaddpermission)
                  <li id="purchase-add-menu"><a href="{{route('purchases.create')}}">{{trans('file.Add Purchase')}}</a></li>
                  @endif -->
                 ...
                 <!--  @if($purchases_import_csv_permision)
...
<?php
              ...
              <li><a href="#store" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span>{{__('file.store')}}</span><span></a>
                <ul id="store" class="collapse list-unstyled ">
                  <!-- -->
                  @if($index_permission_active)
                  <li id="store-list-menu"><a href="{{route('storelist')}}">{{__('file.store_list')}}</a></li>
                  <?php 
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="store-create-menu"><a href="{{route('store.create')}}">{{__('file.add_store')}}</a></li>
                  <li id="store-create-menu"><a href="{{route('store_production_list')}}">{{__('file.Received Stock')}}</a></li>
                     <li id="store-create-menu"><a href="{{route('StoreItem')}}">{{__('file.Store Request')}}</a></li>


                     <li id="store-create-menu"><a href="">{{__('file.Store Request Form')}}</a></li>
              ...
              <li><a href="#Shipment" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span>{{__('file.Shipment')}}</span><span></a>
                <ul id="Shipment" class="collapse list-unstyled ">
                  <!-- -->
                  @if($index_permission_active)
                  <li id="Shipment-create-menu"><a href="{{route('shipment-list')}}">{{__('file.Shipment List')}}</a></li>
                  @endif
                      @if($index_permission_active)
                  <li id="Shipment-create-menu"><a href="{{route('addshipment')}}">{{__('file.Shipment Add Shipment')}}</a></li>
                  @endif
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span>{{trans('file.Sale')}}</span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li><a href="{{route('sale.pos')}}">POS</a></li>
                    ...
                    <li id="sale-create-menu"><a href="{{route('add_shipment_sale')}}">{{trans('file.Add Shipment Sale')}}</a></li>

                  <li id="sale-create-menu"><a href="{{route('sales.create')}}">{{trans('file.Add Sale')}}</a></li>

                  <li id="sale-create-menu"><a href="{{route('IndexShipment')}}">{{trans('file.Shipping Index')}}</a></li>
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><span>{{trans('file.People')}}</span></a>
                <ul id="people" class="collapse list-unstyled ">
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="customer-create-menu"><a href="">{{trans('file.Add Customer')}}</a></li>
                  @endif
                  @endif
                 ...
                 <?php 
                  ...
                  ?>
                  @if($index_permission_active)
                  <li id="shipment-list-menu"><a href="{{route('ShipmentAgentindex')}}">{{trans('file.ShipmentAgent')}}</a></li>
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="shipment-create-menu"><a href="{{route('ShipmentAgentCreate')}}">{{trans('file.Add ShipmentAgent')}}</a></li>
                  @endif
                  @endif
...
<!-- 
                  ...
                  <li><a href="{{route('purchase_category')}}"><span>{{trans('file.Pruchase Category')}}</a></span>
                  </li>
