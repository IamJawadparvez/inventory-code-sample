...
<section>
    <div class="container-fluid">
            ...
            <a href="{{route('store.create')}}" class="btn btn-info"><i class="fa fa-plus"></i> {{__('file.Add Store')}}</a>
             ...
             <td>{{$s->name}}</td>
              <td>{{$s->email}}</td>
               <td>{{$s->phone}}</td>
                <td>{{$s->address}}</td>
                <td>{{$s->stock_count}}</td>
                <td><a href="{{route('editstore',['id'=>$s->id])}}"><i class="fa fa-edit"></i></a>
                <a href="{{route('deletestore',['id'=>$s->id])}}"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
             @endforeach
            </tbody>
