            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form" method="Post" action="{{route('updatestore',['id'=>$edit->id])}}">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        	...
                                        	<input type="text" required name="name" value="{{$edit->name}}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        	...
                                        	<input type="text" required name="phone" value="{{$edit->phone}}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                        	...
                                        	<input type="email" required name="email" class="form-control" value="{{$edit->email}}">
