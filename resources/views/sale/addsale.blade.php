                                    ...
                                    <div class="row" id="products_div">
                                        <div class="col-md-12" id="final_product">
                                            <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select  name="main_category[]" class="form-control show_category" data-id="subcategory1" id="category1">
                                                                ...
                                                                @endphp
                                                                <option data-div="{{$name}}" data-class="show_filter{{$fl}}" value="{{$cat->id}}">{{$cat->name}}</option>
                                                ...
                                                <div class="col-md-3">
                                                    <label class="col-md-12"><strong>{{trans('file.actions')}} *</strong> </label>
                                            ...
                                            <div class="row">
                                                ...
                                                $name = str_replace(' ','_',$name);
                                                @endphp
                                                <div class="col-md-12 show_filter{{$fl}}" id="{{$name}}" style="display: none">
                                                    <div class="row"> 
...
<script type="text/javascript">
var production_subcategory = {!! json_encode($production_subcategory->toArray()) !!};
...
$('#'+id).prop('checked',true);
  ...
  id=$(th).data('id');
        ...
        $.ajax({
        type:'GET',
        url:'{{route("search_production_data")}}',
        dataType: 'json',
