...
<section>
    <div class="container-fluid">
        @if(in_array("products-add", $all_permission))
            <a href="{{route('AddRawMaterial')}}" class="btn btn-info"><i class="fa fa-plus"></i> {{__('file.Add Raw Material')}}</a>
            ...
            <thead>
                <tr>
                   ...
                   <!--  <th>{{trans('file.WareHouse')}}</th> -->
                    ...
                    <th>{{trans('file.SubCategory')}}</th>
                    <th>{{trans('file.Brand Name')}}</th>
...
<tr>
    ...
    <td></td>
     ...
     <!-- <td>{{$raw->product_cost}}</td> -->
      <td>{{$raw->alert_quantity}}</td>
      
      <td>{{$raw->purchasecategory->name}}</td>
      <td>{{isset($raw->purchasesubcategory)?$raw->purchasesubcategory->name:''}}</td>
       <td>{{isset($raw->brand)?$raw->brand->title:''}}</td>
      <td>{{$raw->unit->unit_name}}</td>
