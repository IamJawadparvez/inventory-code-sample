...
class SaleController extends Controller
{
     ...
     $lims_warehouse_list = Warehouse::where('is_active', true)->get();
      $lims_biller_list = Biller::where('is_active', true)->get();
        $lims_tax_list = Tax::where('is_active', true)->get();
            ...
            $production_subcategory = ProductionSubCategory::all();
        return view('sale.addsale',compact('all_permission','lims_customer_list','lims_warehouse_list','lims_biller_list','lims_tax_list','lims_pos_setting_data','category','productioncategory','production_subcategory'));
    }
    public function get_store_product(Request $request)
    {
          $val= $request->val;
         $data= ProductionCategory::Where('name', 'like', '%' . $val . '%')->get(); 
         return $data;
    }
   ...
   public function search_production(Request $request)
   {
       return $request->id;
   }
}
