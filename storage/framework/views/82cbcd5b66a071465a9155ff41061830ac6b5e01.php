          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <?php
                ...
                $index_permission = DB::table('permissions')->where('name', 'production-index')->first();
              ...
              <li><a href="#production" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span><?php echo e(__('file.production')); ?></span><span></a>
                <ul id="production" class="collapse list-unstyled ">
                  <!-- -->
                  <?php if($index_permission_active): ?>

                  <li id="production-list-menu"><a href="<?php echo e(route('productionlist')); ?>"><?php echo e(__('file.production_list')); ?></a></li>

                  <?php 
                    $add_permission = DB::table('permissions')->where('name', 'production-add')->first();
                  ...
                  <li id="production-create-menu"><a href="<?php echo e(route('createproduction')); ?>"><?php echo e(__('file.add_production')); ?></a></li> 




                    <li id="production-create-menu"><a href="<?php echo e(route('allproductionrequests')); ?>"><?php echo e(__('file.production requests')); ?></a></li>                  
                  
                    <li id="production-create-menu"><a href="<?php echo e(route('allrequestform')); ?>"><?php echo e(__('production requests form')); ?></a></li> 

                   <li id="production-create-menu"><a href="<?php echo e(route('production.categories')); ?>"><?php echo e(__('file.Production categories')); ?></a></li>  
              ...
              <li><a href="#purchase" aria-expanded="false" data-toggle="collapse"> <i class="icon-bill"></i><span><?php echo e(trans('file.Purchase')); ?></span></a>
                <ul id="purchase" class="collapse list-unstyled ">
                  ...
                  <?php 
                    $purchase_category = DB::table('permissions')->where('name', 'purchasecategory-index')->first();
                    $purchase_category_perm = DB::table('role_has_permissions')->where([
                        ['permission_id', $purchase_category->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>

                  <?php if($purchase_category_perm): ?>

                 <li id="purchase-category-menu"><a href="<?php echo e(route('purchase_category')); ?>"><?php echo e(trans('file.Purchase Category')); ?></a></li>
                  <?php endif; ?>

                  <?php if($purchase_category_perm): ?>

                 <li id="purchase-category-menu"><a href="<?php echo e(route('AddRawMaterial')); ?>"><?php echo e(trans('file.Add Raw Material')); ?></a></li>
                  <?php endif; ?>
                  ...
                  <?php 
                    $rawMaterial = DB::table('permissions')->where('name', 'purchases-raw-material')->first();
                    $purchaserawMaterial = DB::table('role_has_permissions')->where([
                        ['permission_id', $rawMaterial->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>

                  <?php if($purchaserawMaterial): ?>

                  <li id="purchase-raw-material-menu"><a href="<?php echo e(route('PurchaseRawMaterial')); ?>"><?php echo e(trans('file.Raw Material List')); ?></a></li>                  
                  <?php endif; ?>


                  <?php 
                    $purchaseadd = DB::table('permissions')->where('name', 'purchase-add')->first();
                    $purchaseaddpermission = DB::table('role_has_permissions')->where([
                        ['permission_id', $purchaseadd->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>

               <!--    <?php if($purchaseaddpermission): ?>
                  <li id="purchase-add-menu"><a href="<?php echo e(route('purchases.create')); ?>"><?php echo e(trans('file.Add Purchase')); ?></a></li>
                  <?php endif; ?> -->


                  <?php 
                    $purchases_import_csv = DB::table('permissions')->where('name', 'purchases-import-csv')->first();
                    $purchases_import_csv_permision = DB::table('role_has_permissions')->where([
                        ['permission_id', $purchases_import_csv->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>

                 <!--  <?php if($purchases_import_csv_permision): ?>
...
<?php
              ...
              <?php
                $role = DB::table('roles')->find(Auth::user()->role_id);
                $index_permission = DB::table('permissions')->where('name', 'store-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              <li><a href="#store" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span><?php echo e(__('file.store')); ?></span><span></a>
                <ul id="store" class="collapse list-unstyled ">
                  <!-- -->
                  <?php if($index_permission_active): ?>
                  <li id="store-list-menu"><a href="<?php echo e(route('storelist')); ?>"><?php echo e(__('file.store_list')); ?></a></li>
                  <?php 
                    $add_permission = DB::table('permissions')->where('name', 'store-create')->first();
                    $add_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="store-create-menu"><a href="<?php echo e(route('store.create')); ?>"><?php echo e(__('file.add_store')); ?></a></li>
                  <li id="store-create-menu"><a href="<?php echo e(route('store_production_list')); ?>"><?php echo e(__('file.Received Stock')); ?></a></li>
                     <li id="store-create-menu"><a href="<?php echo e(route('StoreItem')); ?>"><?php echo e(__('file.Store Request')); ?></a></li>


                     <li id="store-create-menu"><a href=""><?php echo e(__('file.Store Request Form')); ?></a></li>
              ...
              <?php
                $role = DB::table('roles')->find(Auth::user()->role_id);
                $index_permission = DB::table('permissions')->where('name', 'Shipment-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                    ['permission_id', $index_permission->id],
                    ['role_id', $role->id]
                ])->first();
              ...
              <li><a href="#Shipment" aria-expanded="false" data-toggle="collapse"> <i class="icon-list"></i><span><?php echo e(__('file.Shipment')); ?></span><span></a>
                <ul id="Shipment" class="collapse list-unstyled ">
                  <!-- -->
                  <?php if($index_permission_active): ?>
                  <li id="Shipment-create-menu"><a href="<?php echo e(route('shipment-list')); ?>"><?php echo e(__('file.Shipment List')); ?></a></li>
                  <?php endif; ?>
                      <?php if($index_permission_active): ?>
                  <li id="Shipment-create-menu"><a href="<?php echo e(route('addshipment')); ?>"><?php echo e(__('file.Shipment Add Shipment')); ?></a></li>
                  <?php endif; ?>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  <li><a href="<?php echo e(route('sale.pos')); ?>">POS</a></li>
                    ...
                    <li id="sale-create-menu"><a href="<?php echo e(route('add_shipment_sale')); ?>"><?php echo e(trans('file.Add Shipment Sale')); ?></a></li>

                  <li id="sale-create-menu"><a href="<?php echo e(route('sales.create')); ?>"><?php echo e(trans('file.Add Sale')); ?></a></li>

                  <li id="sale-create-menu"><a href="<?php echo e(route('IndexShipment')); ?>"><?php echo e(trans('file.Shipping Index')); ?></a></li>
              ...
              <li><a href="#people" aria-expanded="false" data-toggle="collapse"> <i class="icon-user"></i><span><?php echo e(trans('file.People')); ?></span></a>
                <ul id="people" class="collapse list-unstyled ">
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="customer-create-menu"><a href=""><?php echo e(trans('file.Add Customer')); ?></a></li>
                  <?php endif; ?>
                  <?php endif; ?>
                 ...
                 <?php 
                    $index_permission = DB::table('permissions')->where('name', 'shipmentagent-index')->first();
                    $index_permission_active = DB::table('role_has_permissions')->where([
                            ['permission_id', $index_permission->id],
                            ['role_id', $role->id]
                        ])->first();
                    //dd($index_permission_active);
                  ?>
                  <?php if($index_permission_active): ?>
                  <li id="shipment-list-menu"><a href="<?php echo e(route('ShipmentAgentindex')); ?>"><?php echo e(trans('file.ShipmentAgent')); ?></a></li>
                  
                  <?php 
                    $add_permission = DB::table('permissions')->where('name', 'shipmentagent-add')->first();
                    $add_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
                  ?>
                  <?php if($add_permission_active): ?>
                  <li id="shipment-create-menu"><a href="<?php echo e(route('ShipmentAgentCreate')); ?>"><?php echo e(trans('file.Add ShipmentAgent')); ?></a></li>
                  <?php endif; ?>
                  <?php endif; ?>
              ...
              <li><a href="#setting" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-gear-outline"></i><span><?php echo e(trans('file.settings')); ?></span></a>
                ...
                <ul id="setting" class="collapse list-unstyled ">
                  <?php
                      ...
                      //   $Purchase_Category = DB::table('permissions')->where('name', 'purchasecategory-index')->first();
                      // //  dd($Purchase_Category);
                      // $Purchase_Category_active = DB::table('role_has_permissions')->where([
                      //             ['permission_id', $Purchase_Category->id],
                      //             ['role_id', $role->id]
                      //         ])->first();
...
<!-- 
                  ...
                  <li><a href="<?php echo e(route('purchase_category')); ?>"><span><?php echo e(trans('file.Pruchase Category')); ?></a></span>
                  </li>
