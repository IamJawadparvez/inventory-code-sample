            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Add Raw Material')); ?></h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <form id="raw_material-form" method="POST" action="<?php echo e(route('saverawmaterial')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="row">
                                ...
                                <!-- <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Ware House')); ?> *</strong> </label>
                                        <div class="input-group">
                                            <select name="store_id"  class="form-control selectpicker" id="store_id">
                                                <option value="<?php echo e(NULL); ?>">Choose</option>
                                                <?php $__currentLoopData = $warehouse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $war): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($war->id); ?>"><?php echo e($war->name); ?></option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.Purchase Category')); ?> *</strong> </label>
                                        <div class="input-group">
                                ...
                                <div class="col-md-6 form-group">
                                                ...
                                                <div class="input-group">
                                                 ...
                                                 <option value="<?php echo e($u->id); ?>"><?php echo e($u->unit_name); ?></option>
                                                 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                  </select>
                                              </div>
