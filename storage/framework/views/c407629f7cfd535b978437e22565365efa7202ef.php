...
<section>
    <div class="container-fluid">
            ...
            <a href="<?php echo e(route('store.create')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(__('file.Add Store')); ?></a>
        ...
        <table id="product-data-table" class="table table-striped" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(trans('file.Stock Count')); ?></th>
             ...
             <td><?php echo e($s->name); ?></td>
              <td><?php echo e($s->email); ?></td>
               <td><?php echo e($s->phone); ?></td>
                ...
                <td><?php echo e($s->stock_count); ?></td>
                <td><a href="<?php echo e(route('editstore',['id'=>$s->id])); ?>"><i class="fa fa-edit"></i></a>
                <a href="<?php echo e(route('deletestore',['id'=>$s->id])); ?>"><i class="fa fa-trash"></i></a>
            </td>
        </tr>
...
<script>
    ...
    $("ul#store").siblings('a').attr('aria-expanded','true');
    $("ul#store").addClass("show");
    $("ul#store #store-list-menu").addClass("active");
