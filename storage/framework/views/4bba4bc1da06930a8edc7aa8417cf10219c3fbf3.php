...
<section>
    <div class="container-fluid">
        <?php if(in_array("products-add", $all_permission)): ?>
            <a href="<?php echo e(route('AddRawMaterial')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> <?php echo e(__('file.Add Raw Material')); ?></a>
            ...
            <thead>
                <tr>
                   ...
                   <!--  <th><?php echo e(trans('file.WareHouse')); ?></th> -->
                    ...
                    <th><?php echo e(trans('file.SubCategory')); ?></th>
                    <th><?php echo e(trans('file.Brand Name')); ?></th>
                    <th><?php echo e(trans('file.Product Unit')); ?></th>
...
<?php $__currentLoopData = $rawmaterial; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $raw): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<tr>
    
    <td></td>
     <td><?php echo e($raw->product_name); ?></td>
     <!-- <td><?php echo e($raw->product_cost); ?></td> -->
      <td><?php echo e($raw->alert_quantity); ?></td>
      
      <td><?php echo e($raw->purchasecategory->name); ?></td>
      <td><?php echo e(isset($raw->purchasesubcategory)?$raw->purchasesubcategory->name:''); ?></td>
       <td><?php echo e(isset($raw->brand)?$raw->brand->title:''); ?></td>
      <td><?php echo e($raw->unit->unit_name); ?></td>
...
<div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <button type="button" data-id="21" class="open-EditCategoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="fa fa-edit"></i> Edit</button>
                                </li>
...
<script>
    ...
    $("ul#purchase #purchase-raw-material-menu").addClass("active");
