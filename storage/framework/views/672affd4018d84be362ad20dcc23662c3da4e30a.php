            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(trans('file.Send Shipment List')); ?></h4>
                    </div>
                    <div class="card-body">
                    ...
                    <?php $allheads = DB::table('production_subcategories')->where('category_id',$cat->id)->where('parent_id',NULL)->select('id','name')->get(); ?>
                        ...
                        <div class="tab-pane fade show <?php if($i==0) echo 'active' ?>" id="nav-<?php echo e($name); ?>" role="tabpanel" aria-labelledby="nav-<?php echo e($name); ?>-tab">
                            ...
                            <tbody>
                               ...
                               <?php
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   ...
                                   <td><?php if($pro->shipment_status==0): ?><?php echo e('Pending'); ?> <?php else: ?> <?php echo e('Approved'); ?> <?php endif; ?></td>
                                   <td>
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="<?php echo e(route('shipmentApproved',['id'=>$pro->id])); ?>" type="button" data-id="21"  class="open-EditCategoryDialog btn btn-link" data-target="#editModal"><i class="fa fa-edit"></i> Send For Sale</a>
                                </li>
