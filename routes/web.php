...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::post('addstores','StoreController@store')->name('addstores');

	Route::get('storelist','StoreController@show')->name('storelist');

	Route::get('editstore/{id}','StoreController@edit')->name('editstore');
    Route::post('storeupdate/{id}','StoreController@update')->name('updatestore');
    Route::get('deletestore/{id}','StoreController@destroy')->name('deletestore');



	Route::get('createproduction','ProductionController@create')->name('createproduction');    
	Route::post('addproduction','ProductionController@store')->name('addproduction');

	Route::get('productionlist','ProductionController@show')->name('productionlist');
	...
	Route::get('productionlist','ProductionController@show')->name('productionlist');
  	Route::post('showproduct','ProductionController@productshow')->name('showproduct');


	Route::get('editproduction/{id}','ProductionController@edit')->name('editproduction');
    Route::post('productionupdate/{id}','ProductionController@update')->name('updateproduction');
    Route::get('deleteproduction/{id}','ProductionController@destroy')->name('deleteproduction');


    Route::get('getcolordata/{id}','ProductionController@getcolordata')->name('getcolordata');
    Route::get('getgcmdata/{id}','ProductionController@getgcmdata')->name('getgcmdata');    

    Route::get('getcolordata/{id}','ProductionController@getcolordata')->name('getcolordata');
    Route::get('getgcmdata/{id}','ProductionController@getgcmdata')->name('getgcmdata');
    Route::get('getgownsize/{id}','ProductionController@getgownsize')->name('getgownsize'); 


     Route::get('rawmaterial','ProductionController@rawmaterial')->name('rawmaterial');

      Route::get('getpurchasesubcategory','PurchaseController@purchasecategory')->name('getpurchasesubcategory');


        Route::get('warehouse_list/{id}','ProductionController@material')->name('warehouse_list');
        Route::post('new_request_raw_material','ProductionController@request_raw_material')->name('new_request_raw_material');        

        Route::get('productionrequests','ProductionController@productionrequests')->name('productionrequests');

        Route::get('allproductionrequests','ProductionController@allproductionrequests')->name('allproductionrequests');

         Route::get('requestform','ProductionController@allrequestform')->name('allrequestform');


        Route::get('approverequest/{id}','ProductionController@approverequest')->name('approverequest');                


        Route::get('rejectrequest/{id}','ProductionController@rejectrequest')->name('rejectrequest');

         Route::get('PurchaseCategory','PurchaseCategoryController@index')->name('purchase_category');

          Route::Post('AddPurchase','PurchaseCategoryController@store')->name('AddPurchase');  
           Route::get('purchaseedit/{id}','PurchaseCategoryController@edit')->name('purchase_categoryedit');

          Route::get('AddShipment','ShipmentController@create')->name('AddShipment');                     

         Route::Post('createshipping','ShipmentController@store')->name('createshipping'); 


          Route::get('IndexShipment','ShipmentController@index')->name('IndexShipment');   

          Route::get('PurchaseRawMaterial','PurchaseController@purchaserawmaterial')->name('PurchaseRawMaterial');   
           Route::get('AddRawMaterial','PurchaseController@newrawmaterial')->name('AddRawMaterial');  

           Route::post('saverawmaterial','PurchaseController@save_raw_material')->name('saverawmaterial');             

           Route::get('get_raw_matetial_product','PurchaseController@get_raw_matetial_product')->name('get_raw_matetial_product');

            Route::get('ShipmentAgentCreate','ShipmentAgentController@shipmentagent')->name('ShipmentAgentCreate');  

            Route::get('ShipmentAgentindex','ShipmentAgentController@shipmentagentindex')->name('ShipmentAgentindex'); 

             Route::Post('PurchaseSave','PurchaseController@purchasesave')->name('PurchaseSave'); 


            Route::get('production.categories','ProductionCategoryController@production_categories')->name('production.categories'); 

            Route::post('production-categories-save','ProductionCategoryController@production_categories_save')->name('
            	production-categories-save');             

            Route::post('production-subcategories-save','ProductionCategoryController@production_sub_categories_save')->name('
            	production-subcategories-save');             


            Route::get('production.subcategories/{id}','ProductionCategoryController@production_sub_categories')->name('production.subcategories'); 

            Route::get('StoreList','StoreController@index')->name('store_production_list');


            Route::get('ProductionApproved/{id}','ProductionController@change_status')->name('ProductionApproved');

            Route::get('StoreApproved/{id}','StoreController@change_status')->name('StoreApproved');

            Route::get('shipmentApproved/{id}','StoreController@change_shipment_status')->name('shipmentApproved');

            Route::get('StoreItem','StoreController@materaillist')->name('StoreItem');

            Route::get('ProductionRequest/{id}','StoreController@productionrequest')->name('ProductionRequest');
            


            // Route::get('ShipmentList','')->name('ShipmentList');
            Route::post('save-issue-request','ProductionController@save_issue_request')->name('save-issue-request');

            Route::get('delete-production-request/{id}','StoreController@delete_production_request')->name('delete-production-request');


            Route::post('store-update-issue-request','StoreController@store_update_issue_request')->name('store-update-issue-request');

            Route::get('shipment-list','ShipmentController@shipment_list')->name('shipment-list');

            Route::get('Send-Shipment/{id}','ShipmentController@send_shipment')->name('Send-Shipment');
             Route::post('ShipmentSave','ShipmentController@shipment_save')->name('ShipmentSave');

              Route::get('addshipment','ShipmentController@add_shipment')->name('addshipment');
				Route::get('add-shipment-data','ShipmentController@add_shipment_data')->name('add-shipment-data');              
				Route::get('get_production_data','ShipmentController@get_production_data')->name('get_production_data'); 


				Route::get('search_production_data','ShipmentController@search_production_data')->name('search_production_data'); 

				Route::Post('save-issue-shipment','ShipmentController@save_issue_shipment')->name('save-issue-shipment'); 

				Route::get('add_shipment_sale','SaleController@add_sale')->name('add_shipment_sale'); 

				Route::get('get_store_product','SaleController@get_store_product')->name('get_store_product'); 

				Route::get('get_rawmaterial_list','PurchaseController@get_rawmaterial_list')->name('get_rawmaterial_list'); 


				Route::post('sale-save','SalesFinalProductController@sales_save')->name('sales-save');


				Route::get('sale-report/{id}','SalesFinalProductItemsController@sales_print')->name('sales-report');
